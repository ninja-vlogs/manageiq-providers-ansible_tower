...
class PopulateTower
  ...
  # Created name=hello_aliyun_cred              manager_ref/ems_ref= 139       url=/api/v1/credentials/139/
  ...
  def create_dataset
    ...
    # create cloud aliyun cred
    data = {
      :name         => 'hello_aliyun_cred',
      :kind         => 'aliyun',
      :username     => 'ABC',
      :password     => 'abc',
      :organization => organization['id']
    }
    aliyun_credential = create_obj(uri, data)
    ...
    data = {
      ...
      :cloud_credential   => aliyun_credential['id'],
